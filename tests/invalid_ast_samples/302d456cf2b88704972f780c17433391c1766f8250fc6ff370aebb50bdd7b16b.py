...
# Source:
# async def name_4():
#     [name_5 async for name_0 in name_1] |= name_1
#
#
# Error:
#     SyntaxError("'list comprehension' is an illegal expression for augmented assignment", ('<file>', 2, 5, '    [name_5 async for name_0 in name_1] |= name_1\n', 2, 40))
